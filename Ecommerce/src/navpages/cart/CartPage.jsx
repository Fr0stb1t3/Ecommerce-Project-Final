                            ...
                            <ul role="list" className="divide-y divide-gray-200">
                                {cartItems.length > 0 ?
                                    ...
                                    <div>
                                            ...
                                            <img className=" mb-4" src="https://cdn-icons-png.flaticon.com/512/5089/5089733.png" alt="" />
                                            </div>
                                            <h1 className="flex justify-center text-black text-xl">Cart Looks empty</h1>
                                    </div>}
                            </ul>
                        </section>
                        {/* Order summary */}
